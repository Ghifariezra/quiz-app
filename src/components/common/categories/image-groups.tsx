			...
			{ImageQuiz.map((image, index) => (
				<Link
					...
					<motion.div
						...
						className="aspect-square bg-cover bg-center scale-90 rounded-lg overflow-hidden drop-shadow-xl drop-shadow-slate-500/50 dark:drop-shadow-white-500/50 bg-slate-50 dark:bg-slate-900">
